...
export default function AdminInsertNewItem() {
  ...
  async function handleItemInsert() {
    ...
    const data = {
      ...
      idEspacoOrganizacional: { idEspacoOrganizacional: storagePositionId },
    };
  ...
  return (
    <div id="div-screen">
            ...
            <div className="div-checkbox-dad">
              <div>
                ...
                <input
                  ...
                  checked={disposable}
                  onChange={(e: any) => {
                    setDisposable(e.target.checked);
                  }}
                />
              </div>
              <div>
      ...
      <div id="div-button">
        <button onClick={() => handleItemInsert()} id="button">
          Cadastrar item
        </button>
      </div>
    </div>
