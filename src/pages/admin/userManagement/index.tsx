            ...
            <div className="manage-table">
              ...
              <div className="div-itens">
                ...
                <div className="div-funcao-content">
                  {divFunc == true && (
                    <div className="div-func">
                      <h3 id="function" className="emplys-content">
                        {func}
                      </h3>
                      {isEditOn && (
                        <img
                    ...
                    <div className="div-list">
                      ...
                      <div className="div-list-content">
                        <h3
                          ...
                          onClick={() => changeContent("Administrador")}
                        >
                          Administrador
                        </h3>
                        <h3
                          className="list-content"
                          onClick={() => changeContent("Professor")}
                        >
                          Professor
                        </h3>
                        <h3
                          className="list-content"
                          onClick={() => changeContent("Atendente")}
                        >
                          Atendente
                        </h3>
                        <h3
                          className="list-content"
                          onClick={() => changeContent("Assistente")}
                        >
                          Assistente
                        </h3>
                      </div>
                ...
                <div className="div-icons">
                  <Tooltip title="Editar nível de acesso">
                    <div
            ...
            <div className="manage-table">
              ...
              <div className="div-itens">
                ...
                <div className="div-funcao-content">
                  {divFunc2 == true && (
                    <div
                      className="div-func-user"
                      onClick={() => showHideUser()}
                    >
                      <h3 id="function" className="emplys-content">
                        {func2}
                      </h3>
                  ...
                  {divFunc2 == false && (
                    <div className="div-list" onClick={() => showHideUser()}>
                      ...
                      <div className="div-list-content">
                        <h3
                          className="list-content"
                          onClick={() => changeContentUser("Administrador")}
                        >
                          Administrador
                        </h3>
                        <h3
                          className="list-content"
                          onClick={() => changeContentUser("Professor")}
                        >
                          Professor
                        </h3>
                        <h3
                          className="list-content"
                          onClick={() => changeContentUser("Atendente")}
                        >
                          Atendente
                        </h3>
                        <h3
                          className="list-content"
                          onClick={() => changeContentUser("Assistente")}
                        >
                          Assistente
                        </h3>
                      </div>
